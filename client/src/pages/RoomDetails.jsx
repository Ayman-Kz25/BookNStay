        ...
        <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
          ...
          <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
            <div className="flex flex-col">
              ...
              <input type="date" id="checkinDate" placeholder="Check-In" className="w-full rounded-lg border border-gray-300 px-3 py-2 mt-1.5 outline-none" required/>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <input type="date" id="checkoutDate" placeholder="Check-Out" className="w-full rounded-lg border border-gray-300 px-3 py-2 mt-1.5 outline-none" required/>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <input type="number" id="guests" placeholder="0" className="max-w-20 rounded-lg border border-gray-300 px-3 py-2 mt-1.5 outline-none" min="1" max="5" required/>
            </div>
          </div>

          {/* Right */}
          <button type="submit" className="bg-[var(--primary)] hover:bg-[var(--secondary)]/90 active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-24 py-3 md:py-4 text-base cursor-pointer">
            Book Now
          </button>
